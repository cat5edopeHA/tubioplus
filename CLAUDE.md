...
## Testing Branch Specifics

This branch adds two features not yet on main:
- **4K quality option** — adds 2160p to the quality selector and stream output
- **BASE_PATH support** — allows mounting the addon under a sub-path (e.g. `/tubio`) behind a reverse proxy
...
# Docker pull
docker pull cat5edopeha/tubioplus:testing
